...
const Button = ({
    ...
    const buttonClasses = cn(
        `group h-12 px-8 inline-flex justify-center items-center gap-2 text-lg uppercase font-anton tracking-widest outline-none transition-colors relative overflow-hidden focus-ring`,
        variantClasses,
        { [iconClasses]: icon },
        className,
    );
